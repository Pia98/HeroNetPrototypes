class AdBots {
    ...
    update() {
        this.bots.forEach(b => {
            ...
            if(b.creationTime <= 0 && !(b.madeSticker)) {
                ...
                botAd.scale = 0.1;
                botAd.color = colorPalette[Math.floor(Math.random() * 8)];
                botAd.strokeColor = colorPalette[Math.floor(Math.random() * 8)];
                botAd.textColor = colorPalette[Math.floor(Math.random() * 8)];
                botAd.textStrokeColor = colorPalette[Math.floor(Math.random() * 8)];
                botAd.text = textPalette[Math.floor(Math.random() * 5)];
